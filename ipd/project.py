...
class Project:
    ...
    def mark_superseded(self, deployment_uuid: str) -> None:
        self.superseded.append(deployment_uuid)

        if len(self.superseded) > SUPERSEDED_MAX:
            del self.superseded[:-SUPERSEDED_MAX]
